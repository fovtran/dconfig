...
Screen::Screen(int width, int height) :mMargin(0), mWidth(width), mHeight(height) {}
Screen::~Screen()
{
...
void Screen::setMargin(int margin) { mMargin = margin; }
...
void Screen::setWidth(int width) { mWidth = width; }
void Screen::setHeight(int height) { mWidth = height; }
int Screen::getWaveCount() const { return mWaves.size(); }