...
Encoder::Encoder(int width, int height, int frameRate) : mWidth(width), mHeight(height), mFrameRate(frameRate), 
	mBitRate(8000000), mOutputFile(NULL) { avcodec_register_all(); }
Encoder::~Encoder() {}	
...
void Encoder::setFramerate(int frameRate) {	mFrameRate = frameRate; }
void Encoder::setBitrate(int bitrate) { mBitRate = bitrate; }
